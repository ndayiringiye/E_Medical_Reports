...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchSymptoms = async () => {
      setLoading(true);
      try {
        const res = await axios.get("https://e-medical-reports-backd.onrender.com/api/user/getsymptoms");
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://e-medical-reports-backd.onrender.com/api/user/deleteSymptom/${id}`);
